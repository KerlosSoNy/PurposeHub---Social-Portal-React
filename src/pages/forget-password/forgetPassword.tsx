...
export default function ForgetPassword() {
    ...
    return (
        <div className="!bg-white relative  flex flex-row justify-center p-[20px] sm:p-[32px]">
            ...
            lg:w-[calc(100%-626px)] 
            ${error?.email ? "pt-[10px] sm:pt-[47px] xl:pt-[97px] 3xl:pt-[147px]" : "pt-[20px] sm:pt-[50px] xl:pt-[90px] 3xl:pt-[157px]"} gap-[50px]`}>
