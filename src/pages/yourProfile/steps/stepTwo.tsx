import LargeCategorySelector from '../../../components/categoriesCarousel/large/largeCategoryCarousel'
...
export default function StepTwo({ setSelectedCategory, setShowErrorToast, setTitle, setBody, selectedCategory, setStep, step }: StepTwo) {
    const nextStep = () => {
    ...
    return (
        <div className='px-[30px] xl:px-[210px] mt-[45px] flex flex-col gap-[32px]'>
            ...
            <LargeCategorySelector selectedCategories={selectedCategory} setSelectedCategories={setSelectedCategory} />
